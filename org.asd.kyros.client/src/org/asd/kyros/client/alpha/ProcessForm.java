...
import org.asd.kyros.client.alpha.ProcessForm.MainBox.GeneralBox.BuildUpPerSideField;
import org.asd.kyros.client.alpha.ProcessForm.MainBox.GeneralBox.CommonNameField;
...
import org.asd.kyros.client.alpha.ProcessForm.MainBox.GeneralBox.LeadTimeDaysField;
...
public class ProcessForm extends AbstractForm {
  ...
  /**
   * @return the BuildUpPerSideField
   */
  public BuildUpPerSideField getBuildUpPerSideField(){
    return getFieldByClass(BuildUpPerSideField.class);
  }
  ...
  /**
   * @return the CommonNameField
   */
  public CommonNameField getCommonNameField(){
    return getFieldByClass(CommonNameField.class);
  }
  ...
  /**
   * @return the LeadTimeDaysField
   */
  public LeadTimeDaysField getLeadTimeDaysField(){
    return getFieldByClass(LeadTimeDaysField.class);
  }
  ...
  public class MainBox extends AbstractGroupBox {
    ...
    public class GeneralBox extends AbstractGroupBox {
      ...
      @Order(50.0)
      public class CommonNameField extends AbstractStringField {

        @Override
        protected String getConfiguredLabel() {
          return TEXTS.get("CommonName");
        }
      ...
      @Order(60.0)
      public class LeadTimeDaysField extends AbstractStringField {

        @Override
        protected String getConfiguredLabel() {
          return TEXTS.get("LeadTimeDays");
        }
      ...
      @Order(70.0)
      public class BuildUpPerSideField extends AbstractStringField {

        @Override
        protected String getConfiguredLabel() {
          return TEXTS.get("BuildUpPerSide");
        }
