...
import org.asd.kyros.client.alpha.DivisionForm.MainBox.GeneralBox.CageCodeField;
import org.asd.kyros.client.alpha.DivisionForm.MainBox.GeneralBox.CompanyField;
...
public class DivisionForm extends AbstractForm {
  ...
  /**
   * @return the CageCodeField
   */
  public CageCodeField getCageCodeField() {
    return getFieldByClass(CageCodeField.class);
  }
  ...
  public class MainBox extends AbstractGroupBox {
    ...
    public class GeneralBox extends AbstractGroupBox {
      ...
      @Order(20.0)
      public class CageCodeField extends AbstractStringField {

        @Override
        protected String getConfiguredLabel() {
          return TEXTS.get("CageCode");
        }
