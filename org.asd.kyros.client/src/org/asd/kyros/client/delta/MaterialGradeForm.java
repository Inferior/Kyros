...
import org.asd.kyros.client.delta.MaterialGradeForm.MainBox.GeneralBox.ConductiveField;
import org.asd.kyros.client.delta.MaterialGradeForm.MainBox.GeneralBox.CorrosionResistantField;
...
public class MaterialGradeForm extends AbstractForm {
  ...
  /**
   * @return the ConductiveField
   */
  public ConductiveField getConductiveField(){
    return getFieldByClass(ConductiveField.class);
  }

  /**
   * @return the CorrosionResistantField
   */
  public CorrosionResistantField getCorrosionResistantField(){
    return getFieldByClass(CorrosionResistantField.class);
  }
  ...
  public class MainBox extends AbstractGroupBox {
    ...
    public class GeneralBox extends AbstractGroupBox {
      ...
      @Order(50.0)
      public class ConductiveField extends AbstractCheckBox {

        @Override
        protected String getConfiguredLabel() {
          return TEXTS.get("Conductive");
        }
      ...
      @Order(60.0)
      public class CorrosionResistantField extends AbstractCheckBox {

        @Override
        protected String getConfiguredLabel() {
          return TEXTS.get("CorrosionResistant");
        }
