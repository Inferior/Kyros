...
public class AddressFormData extends AbstractFormData {
  ...
  public BillingComments getBillingComments() {
    return getFieldByClass(BillingComments.class);
  }
  ...
  public BillingZipCode getBillingZipCode() {
    return getFieldByClass(BillingZipCode.class);
  }
  ...
  public static class BillingComments extends AbstractValueFieldData<String> {
  ...
  public static class BillingZipCode extends AbstractValueFieldData<String> {
