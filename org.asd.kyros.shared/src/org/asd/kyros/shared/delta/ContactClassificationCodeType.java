 ...
 */
  ...
  @Order(40.0)
  public static class EngineerCode extends AbstractCode<Integer> {

    private static final long serialVersionUID = 1L;
    /**
   * 
   */
    public static final Integer ID = 504;

    @Override
    protected String getConfiguredText() {
      return TEXTS.get("Engineer");
    }
   ...
   * 
   */
    public static final Integer ID = 505;
