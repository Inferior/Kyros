...
public class ContactFormData extends AbstractFormData {
  ...
  public FaxNumber getFaxNumber() {
    return getFieldByClass(FaxNumber.class);
  }
  ...
  public PhoneNumber getPhoneNumber() {
    return getFieldByClass(PhoneNumber.class);
  }
  ...
  public static class FaxNumber extends AbstractValueFieldData<String> {
  ...
  public static class PhoneNumber extends AbstractValueFieldData<String> {
  ...
  public static class Type extends AbstractValueFieldData<Integer> {
    ...
    protected void initValidationRules(Map<String, Object> ruleMap) {
      super.initValidationRules(ruleMap);
      ruleMap.put(ValidationRule.CODE_TYPE, ContactClassificationCodeType.class);
      ruleMap.put(ValidationRule.ZERO_NULL_EQUALITY, true);
    }
  }
}
