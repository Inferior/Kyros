 ...
 * org.eclipse.equinox.http.jetty.context.path=/Kyros_server
 ...
 * eclipse.product=org.asd.kyros.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("Kyros server initialized");
    return EXIT_OK;
  }
